...
internal static class StudentsConverter
{
	...
	{
		return new Student(studentDb.Id, studentDb.LastName, studentDb.FirstName, studentDb.Patronymic, studentDb.Gender, studentDb.Age, studentDb.AverageGrade, studentDb.SpecialNotes, studentDb.GroupId);
	}
